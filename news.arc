    ...
    (tag (div id "market-body" class "market-body")
      ...
      (tag (div class "market-detail-grid")
        ...
        (tag (div class "market-constituents-card")
          ...
          (tag (div class "market-constituent-scroll")
            (tag (div class "market-constituent-legend")
              (market-column-sort-button "market-sort-name" "company")
              (market-column-sort-button "market-sort-price" "price")
              (market-column-sort-button "market-sort-day" "day")
              (tag (button id "market-sort-move" class "market-column-sort market-legend-move market-legend-range" type "button" title "Sort by selected range") (pr "1D"))
              (market-column-sort-button "market-sort-market-cap" "market cap")
              (market-column-sort-button "market-sort-pe" "P/E")
              (market-column-sort-button "market-sort-yield" "yield")
      ...
      (spanclass comhead
        ...
        (spanclass navs
          ...
          (when astree
            (prevlink c whence)
            (nextlink c whence))
          (let whenceid (string whence (if astree (+ "#" c!id)))
            (editlink c)
            (when (or (admin) (no astree))
              (flaglink c whenceid))
            (favelink c)
